...
LANGUAGES = ["Afrikaans", "Arabic", "Dutch", "French", "German", "Hindi", "Indonesian", "Italian", "Japanese", "Latvian", "Portuguese, Brazilian", "Romanian", "Russian", "Spanish", "Turkish", "Vietnamese"]
